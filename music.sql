...
VALUES
  ...
  ('Juicy J'), ('Maroon 5'),
  ('Christina Arguilera'), ('Arvil Lavigne'),
  ('Destiney"s Child')
;
...
VALUES
  ...
  ('Daydream'), ('A Star Is Born'), ('Silver Side Up'),
  ('The Blueprint 3'), ('Prism'), ('Hands All Over'),
  ('Lets Go'), ('The Writing"s on the Wall')
;
...
VALUES
  ...
  ('Roy Thomas Baker'), ('Walter Afanasieff'),
  ('Benjamin Rice'), ('Rick Parashar'),
